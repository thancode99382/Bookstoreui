    ...
    >
      {blogJson.map((blog, index) => (
        ...
        style={{width:'400px' , marginRight:'30px'}}
          key={index}
          className="rounded-xl bg-white bg-clip-border text-gray-700 shadow-md relative"
        >
          <div className="relative mx-4 -mt-6 h-40 overflow-hidden rounded-xl bg-blue-gray-500 bg-clip-border text-white shadow-lg shadow-blue-gray-500/40 bg-gradient-to-r from-blue-500 to-blue-600">
            <img
              className="w-240 h-240 md:w-48 md:h-auto md:rounded-none rounded-full mx-auto"
              src={blog.book}
              alt=""
            />
          </div>
